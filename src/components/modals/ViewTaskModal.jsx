...
const ViewTaskModal = ({ isOpen, onClose, task, loading, error, isFromDelegatedTab = false, onTaskUpdate }) => {
  ...
  const { loading: taskLoading, error: taskErrors } = useSelector((state) => state.tasks)
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto relative z-10 m-4">
        ...
        <div className="flex items-center justify-between p-6 border-b">
          <div className="flex items-center gap-3">
            <h2 className="text-2xl font-bold">{isEditMode ? "Edit Task" : "Task Details"}</h2>
            {isEditMode && (
              <span className="px-2 py-1 bg-blue-100 text-blue-800 text-xs font-medium rounded-full">Edit Mode</span>
            )}
            {isFromDelegatedTab && (
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                {isEditMode ? (
                  ...
                  <p className="text-gray-700 leading-relaxed">{taskDescription || "No description provided"}</p>
                )}
              </div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-4">
                        ...
                        <div className="relative">
                          <button
                            ...
                            className={`w-full flex justify-between items-center px-3 py-2 h-10 border rounded-md bg-white ${
                              formErrors.taskAssignedTo ? "border-red-500" : "border-gray-300"
                            }`}
                    ...
                    <div>
                      ...
                      <p className="text-gray-900">{taskStatus.charAt(0).toUpperCase() + taskStatus.slice(1)}</p>
                    </div>
                    ...
                    <div>
                      ...
                      {isEditMode ? (
                        ...
                        <p className="text-gray-900">{taskPriority.charAt(0).toUpperCase() + taskPriority.slice(1)}</p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      {isEditMode ? (
                                  ...
                                  mockCategories.map((category) => (
                                    <li
                                      ...
                                      className={`px-3 py-2 cursor-pointer ${
                                        editFormData.taskCategory === category.name ? "bg-blue-50" : "hover:bg-gray-100"
                                      }`}
                        ...
                        <p className="text-gray-900">{taskCategory || "No category"}</p>
                      )}
                    </div>
